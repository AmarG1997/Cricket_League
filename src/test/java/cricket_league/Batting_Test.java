...
public class Batting_Test {
    ...
    public void givenBattingCsvFile_shouldReturnCsvFileData() throws CricketAnalyzerException {
        ...
        int noOfRecords = cricketAnalyzer.loadDataFile(IPL_2019_BATTING_FILE_PATH,CricketAnalyzer.DataFile.BATTING);
    ...
    public void givenBattingWrongCsvFileType_shouldThrowException()  {
        try{
        CricketAnalyzer cricketAnalyzer = new CricketAnalyzer(CricketAnalyzer.DataFile.BATTING);
        cricketAnalyzer.loadDataFile(IPL_2019_BATTING_WRONG_FILE_PATH,CricketAnalyzer.DataFile.BATTING);
    ...
    public void givenBattingWrongCsvFileHeader_shouldThrowException()  {
        try{
            CricketAnalyzer cricketAnalyzer = new CricketAnalyzer(CricketAnalyzer.DataFile.BATTING);
            cricketAnalyzer.loadDataFile(IPL_2019_BATTING_WRONG_HEADER_FILE_PATH,CricketAnalyzer.DataFile.BATTING);
        }catch (CricketAnalyzerException e) {
            e.printStackTrace();
    ...
    public void givenBattingCsvFile_shouldReturnTopBattingAverages() throws CricketAnalyzerException {
        CricketAnalyzer cricketAnalyzer = new CricketAnalyzer(CricketAnalyzer.DataFile.BATTING);
        cricketAnalyzer.loadDataFile(IPL_2019_BATTING_FILE_PATH,CricketAnalyzer.DataFile.BATTING);
